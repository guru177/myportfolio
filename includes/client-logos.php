...
<svg viewBox="0 0 88 28" class="hero__client-svg" aria-hidden="true">
    <g class="logo-icon logo-icon--laravel">
...
<svg viewBox="0 0 70 28" class="hero__client-svg" aria-hidden="true">
    <g class="logo-icon logo-icon--node">
...
<svg viewBox="0 0 92 28" class="hero__client-svg" aria-hidden="true">
    <g class="logo-icon logo-icon--electron" transform="translate(14 14)">
        <ellipse class="logo-orbit logo-orbit--a" cx="0" cy="0" rx="10.5" ry="4.8" fill="none" stroke="#9a9a9a" stroke-width="1.3"/>
        <ellipse class="logo-orbit logo-orbit--b" cx="0" cy="0" rx="10.5" ry="4.8" fill="none" stroke="#9a9a9a" stroke-width="1.3"/>
        <ellipse class="logo-orbit logo-orbit--c" cx="0" cy="0" rx="10.5" ry="4.8" fill="none" stroke="#9a9a9a" stroke-width="1.3"/>
        <circle class="logo-nucleus" cx="0" cy="0" r="2.3" fill="#9a9a9a"/>
    </g>
...
<svg viewBox="0 0 50 28" class="hero__client-svg" aria-hidden="true">
    <g class="logo-icon logo-icon--php">
        <ellipse class="logo-php-ring" cx="25" cy="14" rx="23" ry="11.5" fill="none" stroke="#9a9a9a" stroke-width="1.4"/>
        <text class="logo-php-text" x="25" y="18.5" text-anchor="middle" font-family="Manrope, sans-serif" font-size="13" font-weight="800" font-style="italic" fill="#9a9a9a">PHP</text>
    </g>
</svg>
<?php else: ?>
<svg viewBox="0 0 78 28" class="hero__client-svg" aria-hidden="true">
    <g class="logo-icon logo-icon--html">
